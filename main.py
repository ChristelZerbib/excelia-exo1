...
def login():
    if request.method == "GET":
        ...
        cursor.execute(f"SELECT password FROM facebook WHERE username ='{username}'") # noqa : E501
        ...
        if db_password[0] != password:
            ...
            cursor.execute(f"UPDATE facebook SET cookie = '{cookie_value}' WHERE username = '{username}'") # noqa : E501
            conn.commit()
